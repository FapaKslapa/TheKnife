...
public class UserHomeController {
    ...
    private void mostraCardRistoranti() {
        ...
        if (ristoranti.isEmpty()) {
            Label noResults = new Label("Nessun ristorante disponibile");
    ...
    private void mostraRistorantiFiltrati(List<Ristorante> ristoranti) {
        ...
        for (Ristorante r : ristoranti) {
            ...
            Label consegnaLabel = new Label(r.isConsegnaDomicilio() ? "🚚 Consegna a domicilio: Sì" : "🚚 Consegna a domicilio: No");
            consegnaLabel.getStyleClass().add("label-consegna-modern");
            if (!r.isConsegnaDomicilio()) consegnaLabel.getStyleClass().add("no");
            ...
            card.getChildren().addAll(
                nome, tipo, prezzo, indirizzoLabel, telefono, consegnaLabel, orariTitle, orariScorrevoli, actions
            );
            ristorantiPane.getChildren().add(card);
        }
    }
