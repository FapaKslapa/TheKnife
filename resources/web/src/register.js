...
function waitForBridge(callback, maxAttempts = 10) {
    ...
    function checkBridge() {
        attempts++;
        if (window.javaConnector && typeof window.javaConnector.registraUtente === 'function') {
            console.log("Bridge trovato, procedo con la registrazione");
            callback();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('registerForm').addEventListener('submit', function (e) {
        ...
        // Attendi che il bridge sia pronto prima di proseguire
